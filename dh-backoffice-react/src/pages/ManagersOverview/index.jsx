...
export default function ManagersOverview() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
      ...
      {/* --- Header --- */}
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-xl shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-stretch">
        ...
        <div className="w-full lg:w-1/3 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-xl shadow-xl shadow-indigo-500/10 border border-white/60 dark:border-slate-700/60 flex flex-col relative overflow-hidden min-h-[400px]">
      ...
      {isGlobalSettingsOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in zoom-in-95 duration-200">
          <div className="bg-transparent w-full max-w-5xl flex flex-col items-end gap-2">
            ...
            <div className="w-full bg-white rounded-xl overflow-hidden shadow-xl max-h-[85vh] overflow-y-auto">
              <GlobalSettingsPanel />
            </div>
          </div>
        </div>
