...
const Checkout = () => {
  ...
  const handleCheckout = async (e) => {
    ...
    // Guard Clause 
    if (!user || !user.uid) {
        return alert("เกิดข้อผิดพลาดในการยืนยันตัวตน กรุณาโหลดหน้าเว็บใหม่");
    }
    ...
    try {
      ...
      const payload = {
        user, // ส่งไปทั้ง object เพื่อความเข้ากันได้
        cartData,
        shippingInfo,
        taxInfo,
  ...
  if (success) {
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800 relative selection:bg-emerald-100 selection:text-emerald-900">
        <Navbar />
        <main className="flex-grow w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10 flex items-center justify-center">
  ...
  if (loading || !cartData) {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800 relative selection:bg-emerald-100 selection:text-emerald-900">
        <Navbar />
        <main className="flex-grow w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10 flex flex-col items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800 relative selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <main className="flex-grow w-full max-w-6xl mx-auto px-4 py-8 animate-in fade-in duration-500 overflow-hidden pb-28 md:pb-12">
