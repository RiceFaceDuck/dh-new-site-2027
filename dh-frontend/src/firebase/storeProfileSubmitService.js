    ...
    try {
      ...
      if (finalStoreData.isSupportActive) {
        ...
        const adPayload = {
           ...
           richDescription: finalStoreData.richDescription || '',
           galleryImages: finalStoreData.galleryImages || [],
           youtubeUrl: finalStoreData.youtubeUrl || '',
           tiktokUrl: finalStoreData.tiktokUrl || '',
           shopeeUrl: finalStoreData.shopeeUrl || '',
           lazadaUrl: finalStoreData.lazadaUrl || '',
           websiteUrl: finalStoreData.websiteUrl || '',
           address: finalStoreData.address || '',
           landmarks: finalStoreData.landmarks || '',
           openHours: finalStoreData.openHours || '',
